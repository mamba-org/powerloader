...
int main()
{
    ...
    // // zcktest.checksums = {Checksum{.type = ChecksumType::SHA256, .checksum = (std::string("06fa557926742aad170074b1ce955014a4213e960e8f09f07fa23371100dd18e"))}};
    // zcktest.checksums = {
    //     Checksum{.type = ChecksumType::SHA256, .checksum = (std::string("1dd70b69d2542b5d5287aa7c2064b76d3c3c3dc49bc698514d89b5ad11ab883f"))}};
