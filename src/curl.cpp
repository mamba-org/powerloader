...
template <class T>
static size_t read_callback(char *ptr, size_t size, size_t nmemb, T *stream)
{
...
void set_string_upload_callback(CURL* handle, std::istringstream* data)
{
...
void set_file_upload_callback(CURL* handle, std::ifstream* data)
{
