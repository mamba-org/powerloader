...
def file(get_proj_root, name="xtensor-0.24.0-hc021e02_0.tar.bz2"):
    ...
    file_map["url"] = (
        "https://beta.mamba.pm/get/conda-forge/osx-arm64/" + file_map["name"]
    )
    ...
    file_map["output_path_pdpart"] = file_map["tmp_path"] / Path(
        str(file_map["name"]) + ".pdpart"
    )
...
def checksums():
    cksums = {
        "xtensor-0.24.0-hc021e02_0.tar.bz2": "e785d6770ea5e69275c920cb1a6385bf22876e83fe5183a011d53fe705b21980",
        "python-3.9.7-hb7a2778_1_cpython.tar.bz2": "6971e6721bbf774a152de720f055d8f9b51439742a09c134698a57a4ed7304ba",
        "xtensor-0.23.10-hd62202e_0.tar.bz2": "e47ed847659b646c20d4e3e6162ebc11a53ecfe565928bea4f6c7110333241d5",
        "xtensor-0.23.10-h4bd325d_0.tar.bz2": "6440497a44cc09fa43fd6606c2461e52fb3cb3f980e7fe949e332c6a468f024a",
        "xtensor-0.23.10-h2acdbc0_0.tar.bz2": "6cfa43e528c21cff3a73b30c48eb04d0332224bd51471a307eea05737c0488d9",
        "xtensor-0.23.10-hc021e02_0.tar.bz2": "c21c3cea6517c2f968548b82008a8f418a5d9f47a41ce1cb796574b5f1bdbb67",
        "xtensor-0.23.10-h940c156_0.tar.bz2": "cc6a113c98012ee9dbbf695a5ce0d8a4230de8342194766e1259d660d1859f6f",
        "xtensor-0.23.9-h4bd325d_1.tar.bz2": "419098106d6c5233f374ec383be6d673d24000c72cf62ca7c56916853b7bdf4f",
        "xtensor-0.23.9-hd62202e_1.tar.bz2": "58c515f6be3aa1cef8cd047068751cab92f7cc525e9d62672e009b104d06f9de",
        "xtensor-0.23.9-h2acdbc0_1.tar.bz2": "70f65c25f8a8c3879923cd01cffc32c603d7675e7657fa9ca265f5565b9203fd",
        "xtensor-0.23.9-hc021e02_1.tar.bz2": "404a2e4664a1cbf94f5f98deaf568b267b7474c4e1267deb367b8c758fe71ed2",
...
def mock_server_password(xprocess, checksums):
    ...
    yield from mock_server(
        xprocess, "m5", port, pkgs, error_type=None, uname="user", pwd="secret"
    )
