...
def start_server(
    port, broken, err_type, username, pwd, content, output_file, host="127.0.0.1"
):
    handler = conda_mock_handler(
        port, broken, err_type, username, pwd, host, content, output_file
    )
